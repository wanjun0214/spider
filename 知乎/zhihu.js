...
xhr : https://www.zhihu.com/api/v4/search_v3?t=general&q=python&correction=1&offset=0&limit=20&filter_fields=&lc_idx=0&show_all_topics=0&search_source=Normal
headers 参数 x-zse-96: 2.0_aL2qb7HqghtxFGFBZuFqFDuBnqSYS0OyZqOyHUH8kXOf
全局搜索 定位
 */
...
var params = {
    ...
    navigator: {
        "appCodeName": "Mozilla",
        "appName": "Netscape",
        "appVersion": "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.74 Safari/537.36",
        "cookieEnabled": true,
        "deviceMemory": 8,
        "doNotTrack": "1",
...
function generate_params(p) {
    let e = JSON.parse(p)
    var c = e.initialState.env.ab.config
        , s = {};
    var r = function (e) {
    ...
    s["X-Ab-Param"] = (0,
        r)(c.params.filter((function (e) {
            return "_all_" === e.chainId
        }
    ))),
        s["X-AB-PB"] = c.encodedParams
    return s
}